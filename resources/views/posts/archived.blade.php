    ...
    <div class="container"> 
        <div class="row"> 
            ...
            <div class="col-sm-9 page-content">
                <div class="inner-box">
                    <h2 class="title-2">
                        <i class="icon-docs"></i> {{ __('Mes consultations archivées') }}
                    </h2>
                    {!! Form::open(['action' => 'PostsController@archived', 'method' => 'GET']) !!}
                        <div class="row">
                            <div class="col-md-12">
                    ...
                    <div class="table-responsive"> 
                        ...
                        <table id="addManageTable" class="table table-striped table-condensed table-bordered table-hover">
                            ...
                            <tbody>
                                @if($posts->count()==0)
                                <tr>
                                    <td colspan="8" class="text-center"><div class="btn btn-danger">{{ __('Aucune offre rattachée') }}</div></td>
                                ...
                                <tr>    
                                    ...
                                    <td>
                                        @if($post->url_state == 'en-cours')
                                            <span class="badge bg-info">{{ __('En Cours') }}</span>
                                        @elseif($post->url_state == 'cloturer')
                                            <span class="badge bg-danger">{{ __('Cloturer') }}</span>
                                        @elseif($post->url_state == 'attribuer')
