<aside id="leftsidebar" class="sidebar">
                ...
                @if(Request::is('admin*'))
                    ...
                    <li class="{{ Request::is('admin/state') ? 'active' : '' }}">
                        <a href="{{ route('admin.state.index') }}">
                            ...
                            <span>{{ __("Statuts Appel d'offre") }}</span>
                        </a>
                    </li>
                    ...
                    <li class="{{ Request::is('admin/open') ? 'active' : '' }}">
                        <a href="{{ route('admin.open.index') }}">
                            ...
                            <span>{{ __("Localité des marchés") }}</span>
                        </a>
                    </li>
                    <li class="{{ Request::is('admin/unit') ? 'active' : '' }}">
                        <a href="{{ route('admin.unit.index') }}">
                            <i class="material-icons">ballot</i>
                            <span>{{ __("Unités de facturation") }}</span>
                        </a>
                    </li>
        ...
        <div class="legal">
            <div class="copyright">
                &copy; 2018 <a href="javascript:void(0);">{{ config('app.name', 'Laravel') }}</a>.
            </div>
            <div class="version">
                <b>Version: </b> 1.0.0
            </div>
